<x-app-layout>
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <form action="{{ route('bookings.store') }}" method="POST" class="bg-white dark:bg-dark-secondary rounded-lg p-8">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <textarea name="notes" rows="4"
                              ...
                              class="w-full bg-white dark:bg-dark border border-gray-300 dark:border-gray-700 rounded px-4 py-2 focus:border-orange focus:ring-orange">{{ old('notes') }}</textarea>
                    @error('notes')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>

                <div class="bg-white dark:bg-dark border border-gray-300 dark:border-gray-700 rounded p-4">
                ...
                <div class="flex gap-4">
                    ...
                    <a href="{{ route('services.index') }}" class="px-8 py-3 rounded-lg font-semibold transition border border-gray-300 dark:border-gray-700 hover:bg-gray-800 text-center">
                        Cancel
                    </a>
                </div>
            </div>
