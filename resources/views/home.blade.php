<x-app-layout>
    <!-- Hero Section -->
    <div class="relative bg-dark-secondary py-32 px-4">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <div class="flex gap-4 justify-center">
                ...
                <a href="{{ route('services.index') }}" class="bg-dark border-2 border-orange text-white px-8 py-4 rounded-lg font-semibold hover:bg-orange-light transition">
                    Book Service
                </a>
            </div>
        </div>
            ...
            @foreach($featuredProducts as $product)
                <a href="{{ route('products.show', $product) }}" class="bg-dark-secondary rounded-lg overflow-hidden hover:ring-2 hover:ring-orange transition">
                    ...
                    <div class="p-6">
                        ...
                        <p class="text-text-secondary mb-4 line-clamp-2">{{ $product->description }}</p>
    ...
    <div class="bg-dark-secondary py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-text-secondary">Expert advice on compatible upgrades for your specific device</p>
                </div>

                <div class="text-center">
                    <div class="text-4xl mb-4">💚</div>
                    <h3 class="text-xl font-semibold mb-2">Honest Advice</h3>
                    <p class="text-text-secondary">We'll tell you if an upgrade makes sense, or if it's time for something new</p>
                </div>

                <div class="text-center">
                    <div class="text-4xl mb-4">🛠️</div>
                    <h3 class="text-xl font-semibold mb-2">Long-Term Support</h3>
                    <p class="text-text-secondary">Professional installation and ongoing support for all upgrades</p>
                </div>
            </div>
        </div>
    </div>
