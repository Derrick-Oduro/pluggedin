    ...
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
                ...
                @else
                    <div class="w-full h-96 bg-dark-secondary rounded-lg flex items-center justify-center">
                        <span class="text-text-secondary text-xl">No Image</span>
                    </div>
                @endif
            </div>
            ...
            <div>
                ...
                <div class="mb-6">
                    <p class="text-text-secondary mb-2">Stock: {{ $product->stock_quantity }} available</p>
                </div>

                <p class="text-text-secondary mb-8 leading-relaxed">{{ $product->description }}</p>
                    ...
                    <form action="{{ route('cart.add', $product) }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number" name="quantity" value="1" min="1" max="{{ $product->stock_quantity }}"
                                   class="w-full bg-dark-secondary border border-gray-700 rounded px-4 py-2">
                        </div>
            ...
            <div class="mt-16">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
                    @foreach($relatedProducts as $related)
                        <a href="{{ route('products.show', $related) }}" class="bg-dark-secondary rounded-lg overflow-hidden hover:ring-2 hover:ring-orange transition">
