<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            @foreach($services as $service)
                <div class="bg-dark-secondary rounded-lg p-8">
                    ...
                    <p class="text-text-secondary mb-6 leading-relaxed">{{ $service->description }}</p>
        ...
        <!-- What to Expect -->
        <div class="bg-dark-secondary rounded-lg p-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div class="text-center">
                    ...
                    <p class="text-text-secondary">Choose your service and preferred date</p>
                </div>

                <div class="text-center">
                    <div class="text-4xl mb-4">✅</div>
                    <h3 class="text-xl font-semibold mb-2">2. Confirmation</h3>
                    <p class="text-text-secondary">We'll review and confirm your booking</p>
                </div>

                <div class="text-center">
                    <div class="text-4xl mb-4">🔧</div>
                    <h3 class="text-xl font-semibold mb-2">3. Professional Service</h3>
                    <p class="text-text-secondary">Expert installation and testing</p>
                </div>
            </div>
        </div>
    </div>
