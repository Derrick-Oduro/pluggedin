...
<x-superadmin-layout>
    <div class="max-w-3xl">
        ...
        <form action="{{ route('superadmin.categories.store') }}" method="POST" class="bg-dark-secondary rounded-lg p-8">
            @csrf
            ...
            <div class="space-y-6">
                <div>
                    ...
                    @enderror
                    <p class="text-text-secondary text-sm mt-1">The slug will be automatically generated from the name</p>
                </div>
